...
// Shared ticket card — dùng chung cho sendPaymentSuccessEmail và sendConfirmedTicketEmail
// full=true: hiển thị đầy đủ tên phim + suất chiếu/ngày/phòng/ghế (dùng cho email vé điện tử)
// full=false: chỉ hiển thị thông tin rạp + QR (dùng cho email thanh toán thành công)
