...
const NEW_MOVIES = [
    // ── Phim hành động ──
    { title: 'Fast X', duration: 141, rating: 3.6, status: 'now_showing', ageRestriction: '13+', genre: 'Action',
    ...
    { title: 'Mission: Impossible – Dead Reckoning', duration: 163, rating: 3.9, status: 'now_showing', ageRestriction: '13+', genre: 'Action',
    ...
    { title: 'John Wick: Chapter 4', duration: 169, rating: 3.9, status: 'now_showing', ageRestriction: '18+', genre: 'Action',
    ...
    { title: 'Guardians of the Galaxy Vol. 3', duration: 150, rating: 4, status: 'now_showing', ageRestriction: '13+', genre: 'Action',
    ...
    { title: 'Deadpool & Wolverine', duration: 127, rating: 3.9, status: 'now_showing', ageRestriction: '18+', genre: 'Action',
    ...
    { title: 'Captain America: Brave New World', duration: 118, rating: 3.1, status: 'now_showing', ageRestriction: '13+', genre: 'Action',
    ...
    { title: 'Aquaman and the Lost Kingdom', duration: 124, rating: 2.7, status: 'now_showing', ageRestriction: '13+', genre: 'Action',
    ...
    { title: 'Thunderbolts*', duration: 127, rating: 3.7, status: 'now_showing', ageRestriction: '13+', genre: 'Action',
    ...
    { title: 'Godzilla x Kong: The New Empire', duration: 115, rating: 3, status: 'now_showing', ageRestriction: '13+', genre: 'Action',
    ...
    { title: 'Kingdom of the Planet of the Apes', duration: 145, rating: 3.6, status: 'now_showing', ageRestriction: '13+', genre: 'Action',
    ...
    { title: 'Dune: Part Two', duration: 166, rating: 4.3, status: 'now_showing', ageRestriction: '13+', genre: 'Sci-Fi',
      poster: 'https://image.tmdb.org/t/p/w500/1pdfLvkbY9ohJlCjQH2CZjjYVvJ.jpg',
      trailer: 'https://www.youtube.com/watch?v=Way9Dexny3w',
      description: 'Paul Atreides liên minh với người Fremen để trả thù gia tộc đã hủy diệt gia đình mình.' },
    { title: 'Oppenheimer', duration: 180, rating: 4.2, status: 'now_showing', ageRestriction: '15+', genre: 'Drama',
    ...
    { title: 'Transformers: Rise of the Beasts', duration: 127, rating: 3, status: 'now_showing', ageRestriction: '13+', genre: 'Sci-Fi',
    ...
    { title: 'Alien: Romulus', duration: 119, rating: 3.7, status: 'now_showing', ageRestriction: '18+', genre: 'Sci-Fi',
    ...
    // ── Phim kinh dị ──
    { title: 'Smile 2', duration: 127, rating: 3.3, status: 'now_showing', ageRestriction: '18+', genre: 'Horror',
    ...
    { title: 'A Quiet Place: Day One', duration: 99, rating: 3.6, status: 'now_showing', ageRestriction: '15+', genre: 'Horror',
    ...
    { title: 'The Substance', duration: 141, rating: 3.7, status: 'now_showing', ageRestriction: '18+', genre: 'Horror',
    ...
    // ── Phim hài / gia đình ──
    { title: 'Barbie', duration: 114, rating: 3.5, status: 'now_showing', ageRestriction: 'All ages', genre: 'Comedy',
    ...
    { title: 'Inside Out 2', duration: 100, rating: 3.9, status: 'now_showing', ageRestriction: 'All ages', genre: 'Comedy',
    ...
    { title: 'Moana 2', duration: 100, rating: 3.5, status: 'now_showing', ageRestriction: 'All ages', genre: 'Comedy',
    ...
    { title: 'Sonic the Hedgehog 3', duration: 110, rating: 3.5, status: 'now_showing', ageRestriction: 'All ages', genre: 'Comedy',
    ...
    // ── Phim tình cảm / drama ──
    { title: 'Wicked', duration: 160, rating: 3.9, status: 'now_showing', ageRestriction: 'All ages', genre: 'Romance',
    ...
    { title: 'It Ends with Us', duration: 130, rating: 3.3, status: 'now_showing', ageRestriction: '18+', genre: 'Romance',
    ...
    { title: 'Killers of the Flower Moon', duration: 206, rating: 3.8, status: 'now_showing', ageRestriction: '18+', genre: 'Drama',
    ...
    // ── Phim Việt Nam ──
    { title: 'Kẻ Ăn Hồn', duration: 113, rating: 3.4, status: 'now_showing', ageRestriction: '18+', genre: 'Horror',
    ...
    { title: 'Nhà Bà Nữ', duration: 127, rating: 3.8, status: 'now_showing', ageRestriction: 'All ages', genre: 'Comedy',
    ...
    { title: 'Em và Trịnh', duration: 141, rating: 3.5, status: 'now_showing', ageRestriction: 'All ages', genre: 'Romance',
