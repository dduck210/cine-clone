...
import {
  ...
  MapPin,
  Calendar,
  Printer, // Đã thêm icon Printer ở đây
} from "lucide-react";
...
// ------------------------------------------------------------------
// 3. COMPONENT: DASHBOARD TỔNG QUAN
// ------------------------------------------------------------------
const DashboardView = () => (
  <>
...
// ------------------------------------------------------------------
// 4. COMPONENT: QUẢN LÝ THÀNH VIÊN
// ------------------------------------------------------------------
const UsersManager = () => (
  <div className="space-y-6">
...
// ------------------------------------------------------------------
// 5. COMPONENT MỚI: DANH SÁCH ĐƠN HÀNG (Tab Orders)
// ------------------------------------------------------------------
const OrdersManager = ({ onViewTicket }) => {
  const mockOrders = [
    {
      orderId: "XC-99281",
...
// ------------------------------------------------------------------
// 6. COMPONENT MỚI: MODAL CHI TIẾT VÉ / IN VÉ
// ------------------------------------------------------------------
...
// ------------------------------------------------------------------
// 7. COMPONENT CHÍNH: DASHBOARD TỔNG
// ------------------------------------------------------------------
const Dashboard = () => {
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative z-0">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 scroll-smooth">
          ...
          <div className="animate-fade-in-up pb-10">
            ...
            {/* SỬA CHỖ NÀY: Gọi component quản lý đơn hàng */}
            {activeTab === "orders" && (
