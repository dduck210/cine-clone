  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        pageEnter:   { from: { opacity: "0", transform: "translateY(6px)" }, to: { opacity: "1", transform: "translateY(0)" } },
        seatPop:     { "0%": { transform: "scale(1)" }, "45%": { transform: "scale(1.3)" }, "100%": { transform: "scale(1.1)" } },
      },
      animation: {
        ...
        pageEnter:   "pageEnter 0.3s ease forwards",
        seatPop:     "seatPop 0.22s ease forwards",
      },
    },
  },
  plugins: [],
