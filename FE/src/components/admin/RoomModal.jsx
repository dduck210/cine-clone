    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-5">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="text-xs font-bold text-slate-500 dark:text-gray-400 uppercase tracking-wider mb-2 block">
                Tổng số ghế{" "}
                <span className="text-slate-400 dark:text-gray-500 font-normal">(tối thiểu {ROOM_TYPE_INFO[roomType].minSeats})</span>
              </label>
              <input
                type="number"
                value={totalSeats}
            ...
            return (
              <div className={`rounded-2xl border ${info.border} ${info.bg} p-5 shadow-sm transition-all duration-300`}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-3">
                  <div className="bg-white/80 dark:bg-gray-700/80 rounded-xl p-3 border border-white/60 dark:border-gray-600">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-gray-500 mb-1">
                      Yêu cầu ghế
                    </p>
                    <p className="text-xs font-bold text-slate-700 dark:text-gray-200 leading-snug">
                      {info.seatReq}
                    </p>
                  </div>
                  <div className="bg-white/80 dark:bg-gray-700/80 rounded-xl p-3 border border-white/60 dark:border-gray-600">
                ...
                <div className={`rounded-xl px-4 py-3 ${info.bg} border ${info.border} flex items-center gap-3`}>
                  <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-gray-500 shrink-0">
                    Kích thước tối thiểu
                  </span>
                  <span className="text-xs font-bold text-slate-700 dark:text-gray-200">
                    {info.minRows} hàng × {info.minCols} cột
                  </span>
                  <span className="w-1 h-1 rounded-full bg-slate-300 dark:bg-gray-500 shrink-0"></span>
                  <span className="text-xs font-bold text-slate-700 dark:text-gray-200">
        ...
        <div className="px-6 py-4 border-t border-slate-100 dark:border-gray-700 flex justify-end gap-3">
          <button
            onClick={onClose}
            className="px-6 py-2.5 text-slate-600 dark:text-gray-300 hover:bg-slate-100 dark:hover:bg-gray-700 rounded-xl font-semibold transition-all duration-150 active:scale-95 text-sm"
          >
            Hủy
          </button>
          <button
