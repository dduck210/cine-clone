              ...
              {preview.showtimes.length > 0 ? (
                <div className="max-h-48 overflow-y-auto border border-slate-100 dark:border-gray-700 rounded-xl divide-y divide-slate-50 dark:divide-gray-700">
                  {preview.showtimes.map((st) => (
                    <div
                      key={st._id}
                      className="flex items-center justify-between px-4 py-2.5 text-sm hover:bg-slate-50 dark:hover:bg-gray-700"
                    >
                      <div>
                        <p className="font-bold text-slate-800 dark:text-gray-100 line-clamp-1">
                          {st.movieTitle}
                        </p>
