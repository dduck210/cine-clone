...
const Sidebar = ({ activeTab, onTabChange }) => {
  ...
  return (
    <>
    <div className="flex flex-col h-full bg-white dark:bg-gray-900 text-slate-800 dark:text-gray-100 font-sans">
      <div className="h-20 flex items-center justify-center border-b border-slate-50 dark:border-gray-700/50">
      ...
      <div className="flex-1 py-4 px-4 space-y-1 overflow-y-auto custom-scrollbar">
        <div className="mb-4 px-4 text-[11px] font-extrabold text-slate-400 dark:text-gray-500 uppercase tracking-widest">
          Menu Chính
        </div>
              ...
              className={`
                ...
                ${
                  isActive
                    ...
                    : "text-slate-500 dark:text-gray-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-[#dc2626] hover:translate-x-1"
                }
              `}
            >
              <Icon
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? "text-white"
                      : "text-slate-400 dark:text-gray-500 group-hover:text-[#dc2626] group-hover:scale-110 group-hover:-rotate-6"
                  }
                `}
              />
      ...
      <div className="p-4 border-t border-slate-50 dark:border-gray-700/50">
        <button
          onClick={() => setShowLogoutConfirm(true)}
          className="w-full flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-gray-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-[#dc2626] rounded-2xl transition-all duration-300 hover:shadow-sm group active:scale-[0.98]"
        >
          <LogOut
            size={20}
      ...
      {showLogoutConfirm && ReactDOM.createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 mx-4 w-full max-w-sm">
            ...
            <h3 className="text-lg font-black text-gray-900 dark:text-white text-center mb-1">Đăng xuất?</h3>
