...
const FEATURES = [
  { icon: <Film size={22} />, label: "50+ Phim mới", sub: "Cập nhật mỗi tuần" },
  { icon: <MapPin size={22} />, label: "3 Rạp chiếu", sub: "Địa điểm thuận tiện" },
  { icon: <Tag size={22} />, label: "Giảm 20% thứ Hai", sub: "Ưu đãi cố định mỗi tuần" },
  { icon: <Zap size={22} />, label: "Đặt vé siêu nhanh", sub: "Chỉ 3 bước đơn giản" },
];
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/5">
          {FEATURES.map((f, i) => (
            <div
              key={i}
              className="flex items-center gap-3 px-4 sm:px-6 py-4 sm:py-5 group"
