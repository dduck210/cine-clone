    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      >
        <div className="flex justify-between items-center mb-5">
          ...
          <button onClick={onClose} className="p-1.5 rounded-xl hover:bg-slate-100 dark:hover:bg-gray-700 text-slate-400 dark:text-gray-400 transition-all duration-150 active:scale-90">
            <X size={18} />
          </button>
        </div>
        ...
        <div className="flex gap-3">
          <button onClick={onClose} className="flex-1 py-2.5 border border-slate-200 dark:border-gray-600 rounded-xl text-slate-600 dark:text-gray-300 font-semibold hover:bg-slate-50 dark:hover:bg-gray-700/50 text-sm transition-all duration-150 active:scale-95">
            Hủy
          </button>
          <button
            onClick={handleSave}
