            ...
            <div className="space-y-3">
              {cinemaList.map((cinema) => {
                ...
                return (
                  <div
                    key={cinema.id}
                    className={`bg-white dark:bg-gray-800 rounded-2xl border transition-all duration-300 overflow-hidden ${cinema.isOpen ? "border-slate-300 dark:border-gray-600 shadow-md" : "border-slate-200 dark:border-gray-700 shadow-sm hover:border-slate-300 dark:hover:border-gray-600"}`}
                  >
                    <button
                    ...
                    >
                      <div className="flex items-center gap-3.5">
                        ...
                        <div className="text-left">
                          <p className={`font-black text-[15px] leading-tight transition-colors ${cinema.isOpen ? "text-[#dc2626]" : "text-slate-800 dark:text-gray-200"}`}>{cinema.name}</p>
