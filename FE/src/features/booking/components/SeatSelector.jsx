...
/**
 * SeatSelector — renders the cinema seat grid, legend, and handles seat click events.
 * Props:
 *   rows, maxCol, seatMap, seats, loadingSeats, seatLoadError, loadSeats
 *   selectedSeats, justSelected, gapError
 *   handleSeatClick, handleCoupleSeatClick
 *   seatOuterRef, seatInnerRef, seatScale
 *   priceConfig
 *   onShowInfo — callback to open seat type info modal
 */
const SeatSelector = ({
  rows,
  maxCol,
    ...
    <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-2xl shadow-sm p-4 sm:p-8">
      ...
      <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mt-8 border-t border-slate-100 dark:border-gray-700 pt-6">
        ...
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 rounded-md bg-slate-200 dark:bg-gray-600 border border-slate-300 dark:border-gray-500 flex items-center justify-center">
            <span className="text-slate-400 dark:text-gray-400 text-[10px] font-bold">X</span>
          </div>
