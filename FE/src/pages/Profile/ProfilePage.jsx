    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 font-sans text-gray-900 dark:text-white">
      ...
      <div className="container mx-auto px-4 pt-24 md:pt-28 pb-12 max-w-6xl">
        <div className="text-sm text-gray-500 dark:text-gray-400 mb-6">
          Trang chủ /{" "}
          <span className="text-gray-900 dark:text-white font-medium">Tài khoản của tôi</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="md:col-span-4 lg:col-span-3 space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 z-0"></div>
              ...
              <h2 className="relative z-10 text-xl font-bold text-gray-800 dark:text-white">
                {user.name}
              </h2>
...
const MenuButton = ({ active, onClick, icon, label }) => (
  <button
    ...
    className={`w-full flex items-center justify-between p-4 text-sm font-medium transition-all duration-200 border-b border-gray-50 dark:border-gray-700 last:border-0
      ${active ? "bg-red-50 dark:bg-red-900/20 text-red-600 border-l-4 border-l-red-600 pl-3" : "text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 border-l-4 border-l-transparent pl-4"}`}
  >
...
const PersonalInfoTab = ({ storedUser }) => {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-1 border-l-4 border-red-600 pl-3">
        Thông Tin Chung
      </h2>
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-8 pl-4">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 transition-all text-sm font-medium text-gray-900 dark:text-white dark:placeholder-gray-400 ${errors.name ? "border-red-400 focus:border-red-500 focus:ring-red-100 dark:border-red-500" : "border-gray-200 dark:border-gray-600 focus:border-[#dc2626] focus:ring-red-100"}`}
            />
          </div>
          {errors.name && (
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700 border rounded-xl focus:outline-none focus:ring-2 transition-all text-sm font-medium text-gray-900 dark:text-white dark:placeholder-gray-400 ${errors.phone ? "border-red-400 focus:border-red-500 focus:ring-red-100 dark:border-red-500" : "border-gray-200 dark:border-gray-600 focus:border-[#dc2626] focus:ring-red-100"}`}
            />
          </div>
          {errors.phone && (
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-gray-800 dark:text-white border-l-4 border-red-600 pl-3">
          Lịch sử giao dịch
        </h2>
        {paidBookings.length > 0 && (
          <span className="text-xs font-semibold text-gray-400 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-gray-800 dark:text-white text-sm truncate group-hover:text-red-600 transition-colors">
                    {movie.title || "—"}
                  </p>
                  ...
                  <p className="text-[10px] font-mono text-gray-300 dark:text-gray-500 mt-1 truncate">
