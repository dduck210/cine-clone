      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden mb-4">
        ...
        <div className="p-5 space-y-3">
          ...
          <div className="flex gap-6">
            <div>
              <p className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-widest font-bold">Ngày</p>
              <p className="font-bold text-gray-800 dark:text-white">{ticket.showDate ? new Date(ticket.showDate).toLocaleDateString("vi-VN") : "—"}</p>
            </div>
            <div>
              <p className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-widest font-bold">Giờ</p>
              <p className="font-bold text-gray-800 dark:text-white">{ticket.showTime}</p>
            </div>
            <div>
              <p className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-widest font-bold">Ghế</p>
